...
parser.add_argument('--outdir', type=str, default='./RAIN/translation/translation_results')
parser.add_argument('--modelname', type=str, default='meta-llama/Meta-Llama-3-8B-Instruct')
parser.add_argument('--nump', type=int, default=2)
...
for i in range(num_p):
    ...
    command=" --outdir {} --modelname {}".format(start,end,index,gpu_index_str,args.outdir,args.modelname)
